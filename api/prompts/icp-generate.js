...
//   Carla → barsnet.com (also carlaautosystems.com)
...
// string the ICP records carry (see api/data/icps.json - "Carla Auto
// Rental Systems", "Thermeon", "NedFox").
const PORTFOLIO_COMPANY_BRIEFS = {
    'Carla Auto Rental Systems': `Carla Auto Rental Systems makes RentWorks - a fleet / reservation / counter-management platform built specifically for INDEPENDENT car rental operators (not Hertz/Avis/Enterprise scale). Product suite: RentWorks (core platform), RentWorks Mobile, Erez (eCommerce booking layer), LoanerTrack (dealership loaner-car programs). Customer profile: independent rental companies in the 5-200 vehicle range, often family-run, often multi-location; car dealerships running loaner-car programs; and international independent operators. Markets: US primary (customers in NE, FL, WI, KS, OR, NC), Canada, Bermuda, and global "around the world." Positioning: "affordable technological advantage over the big guys" - explicitly hunts independents, NOT enterprise franchises. Typical excludeCompanies for any car-rental ICP serving Carla: Hertz, Avis, Enterprise, Budget, Sixt, Europcar, National, Dollar, Alamo, Thrifty. Typical Maps searchTerms: "car rental", "vehicle hire", "auto rental", "van hire". The vertical label is "Car Rental".`,

    'Thermeon': `Thermeon (thermeon.com) makes CARS+ - a cloud car-rental management and reservation platform. 30+ years in the vertical with offices and staff on six continents. Customer range spans global rental companies through independent operators, but the sweet spot is MID-MARKET: 10-500 vehicles, multi-branch operations, corporate / business-travel customers (deeper feature set than indie-only tools like Carla's RentWorks). Modules: reservations, up-selling, vehicle management, reporting. Notable integrations: Zubie (telematics), Valsoft partnership (Total Fleet Management Solution). Markets: global, UK-headquartered. Positioning: established mid-market platform - more enterprise-capable than indie-only tools. Same indie/mid-market hunting ground as Carla, so typical excludeCompanies are the same: Hertz, Avis, Enterprise, Budget, Sixt, Europcar, National, Dollar, Alamo, Thrifty. Typical Maps searchTerms: "car rental", "vehicle hire", "auto rental", "fleet rental". The vertical label is "Car Rental".`,
