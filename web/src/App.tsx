...
import LiMessagePage from '@/pages/li-message'
      ...
      <div className="flex flex-1 flex-col">
        ...
        <Main>
          <Routes>
            ...
            <Route path="/li-message" element={<LiMessagePage />} />
            ...
            {/* /people is the canonical URL; /leads is kept as an alias so
                old bookmarks/links still resolve to the same page. */}
...
function RouteTitle() {
  const { pathname } = useLocation()
  let title = 'Dashboard'
  if (pathname.startsWith('/email') || pathname.startsWith('/sales-agent')) title = 'Email Generation'
  else if (pathname.startsWith('/li-message')) title = 'LI Message'
  else if (pathname.startsWith('/sourcing')) title = 'New Leads'
  else if (pathname.startsWith('/icp')) title = 'ICPs'
  else if (pathname.startsWith('/templates')) title = 'Email Templates'
  else if (pathname.startsWith('/coverage')) title = 'Coverage'
  else if (pathname.startsWith('/accounts')) title = 'Accounts'
  else if (pathname.startsWith('/database')) title = 'Database'
  else if (pathname.startsWith('/people') || pathname.startsWith('/leads')) title = 'People'
