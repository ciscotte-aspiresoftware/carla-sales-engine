// Theme switch dropdown - sun/moon icon button with light/dark/system options.
// Copied from valsource. The sun/moon icons rotate based on the .dark class
// on <html>, so the visible icon always matches the effective theme even
